<section class="dark:bg-gray-900 2xl:h-screen">
    <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-full md:p-10">
        <div
            class="my-5 w-full rounded-lg shadow border md:mt-0 sm:max-w-2xl xl:p-0 bg-gray-50 dark:bg-gray-800 border-gray-700">
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                <a href="../home" class="magra-bold text-2xl md:text-3xl flex gap-4 items-center mb-6 dark:text-white">
                    <svg class="hover:text-gray-400" viewBox="0 0 21 21" width="41" height="41"
                        ...
                        <g fill="none" fill-rule="evenodd" stroke="currentColor" stroke-linecap="round"
                            ...
                            <path d="m1.378 1.376 4.243.003v4.242" transform="matrix(-.70710678 .70710678 .70710678 .70710678 3.500179 -1.449821)" /><path d="m5.5 9.49998326h5c2 .00089417 3-.99910025 3-2.99998326s-1-3.00088859-3-3.00001674h-10" />
                        </g>
                    </svg>
                    Crear Deportistas
                </a>
                    ...
                    <div class="grid md:grid-cols-2 md:gap-6">
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <select id="tipo-documento" name="tipo-documento"
                                class="cursor-pointer shadow-sm bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light">
